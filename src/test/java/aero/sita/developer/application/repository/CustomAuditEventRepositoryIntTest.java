package aero.sita.developer.application.repository;

import aero.sita.developer.application.Application;
import aero.sita.developer.application.config.Constants;
import aero.sita.developer.application.config.audit.AuditEventConverter;
import aero.sita.developer.application.domain.PersistentAuditEvent;
...
import static aero.sita.developer.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
